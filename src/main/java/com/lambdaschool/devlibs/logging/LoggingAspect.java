package com.lambdaschool.devlibs.logging;
...
public class LoggingAspect {
    @Around(value = "@within(com.lambdaschool.devlibs.logging.Loggable) || @annotation(com.lambdaschool.devlibs.logging.Loggable)")
