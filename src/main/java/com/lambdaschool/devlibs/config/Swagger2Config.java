package com.lambdaschool.devlibs.config;

import com.fasterxml.classmate.TypeResolver;
import com.lambdaschool.devlibs.models.ErrorDetail;
import com.lambdaschool.devlibs.models.TokenModel;
...
public class Swagger2Config {
    ...
    //Thanks to John Mitchell for this code
    private ApiInfo apiEndPointsInfo() {
        return new ApiInfoBuilder().title("DevLibs Project")
                .description("DevLibs Project but in more detail")
                .contact(new Contact("Ronnie Dipple",
                        "http://www.lambdaschool.com",
                        "Ronniedipple@lambdaschool.com"))
                .license("MIT")
                .licenseUrl("https://github.com/BW-DevLibs-Nov2019/Back-End/tree/Development")
                .version(("1.0.0"))
                .build();
    }
}
